...
public class SignatureSAML extends WSSecSignature {

    private final static Logger logger = Logger.getLogger(SignatureSAML.class.getName());
     ...
     * Constructor.
     */
    public SignatureSAML() {
        super();
    }
    /**
     * Constructor.
     */
    public SignatureSAML(WSSConfig config) {
        super(config);
    }
    ...
    public void prepare(Document doc, Crypto uCrypto, AssertionWrapper assertion, Crypto iCrypto, 
        String iKeyName, String iKeyPW, WSSecHeader secHeader) throws WSSecurityException {
