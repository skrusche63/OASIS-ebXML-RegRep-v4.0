...
/**
 * WSS4J is derived from WSSecSignature and is adapted to the special needs of the OASIS
 * ebXML RegRep 3.0 reference implementation. This encloses the support for the provisioning
 * of private keys as well as custom certificate uri
 * 
 * @author Peter Arwanitis (arwanitis@dr-kruscheundpartner.de)
 * @author Stefan Krusche (arwanitis@dr-kruscheundpartner.de)
 */
 ...
 */
public class SignatureBST extends WSSecSignatureBase {

    private final static Logger logger = Logger.getLogger(SignatureBST.class.getName());
    ...
    /*
     * private key to be provided externally
     */
    ...
    public SignatureBST(WSSConfig config) {
        super(config);
        init();
    }
        ...
        if (!(keyIdentifierType == WSConstants.CUSTOM_SYMM_SIGNING
            ...
            if (sigAlgo == null) {
                ...
                if (pubKeyAlgo.equalsIgnoreCase("DSA")) {
                    ...
                    throw new WSSecurityException(WSSecurityException.FAILURE, "unknownSignatureAlgorithm", new Object[] {pubKeyAlgo});
                }
            }
        }
