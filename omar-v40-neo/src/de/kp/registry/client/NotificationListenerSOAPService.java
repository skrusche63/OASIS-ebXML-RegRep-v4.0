...
public class NotificationListenerSOAPService extends Service {
    ...
    private final static Logger logger = Logger.getLogger(de.kp.registry.client.NotificationListenerSOAPService.class.getName());
    ...
    static {
        ...
        try {
            ...
            URL baseUrl = de.kp.registry.client.NotificationListenerSOAPService.class.getResource(".");
