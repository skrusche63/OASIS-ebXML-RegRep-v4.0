...
public class QueryManagerImpl {
	...
	public QueryResponse executeQuery(QueryRequest request) {
		...
		QueryRequestContext queryContext = new QueryRequestContext();
		...
		queryContext.setComment( request.getComment());
		...
		queryContext.setResponseOption(request.getResponseOption());
		
		// Element Query - This element identifies a parameterized query and supplies values 
		// for its parameters.
		
		queryContext.setQuery(request.getQuery());
		...
		queryContext.setQueryDepth(request.getDepth());
		...
		queryContext.setFederation(request.getFederation());
		...
		queryContext.setFormat(request.getFormat());
		...
		queryContext.setLanguage(request.getLang());
		...
		queryContext.setMatchOlderVersions(request.isMatchOlderVersions());
		...
		queryContext.setMaxResults(request.getMaxResults());
		...
		queryContext.setStartIndex(request.getStartIndex());
